...
def parse_args():
    ...
    parser.add_argument("--train_epochs", type=int, default=200, help="Number of epochs for MoCo training")
    ...
    parser.add_argument("--lr", type=float, default=0.0075, help="Learning rate for MoCo training")
